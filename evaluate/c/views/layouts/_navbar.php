...
<nav class="navbar navbar-expand-lg">
	<div class="container">
		<a class="navbar-brand" href="<?= Yii::$app->params['evaluateUrl'] ?>"><?= Yii::$app->params['companyNameEN'] ?> | <small><?= Yii::$app->params['systemName'] ?></small></a>
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu text-center" aria-labelledby="dropdown07">
						<a class="dropdown-item" href="<?= Yii::$app->params['myAccountUrl'] ?>"><i class="fa fa-user"></i> My account</a>
						<div class="dropdown-divider"></div>
